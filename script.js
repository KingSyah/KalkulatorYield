...
function calculateResults(setupNum) {
    ...
    // Calculate effective yield after residue
    const effectiveYield = setup.yieldPerCycle * (1 - setup.residuePercentage / 100);
    ...
    const totalResidue = (setup.yieldPerCycle * setup.residuePercentage / 100) * totalCycles;
